			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="department-label" class="property-label"><g:message code="user.department.label" default="Department" /></span>
						...
						<span class="property-value" aria-labelledby="department-label"><g:message code="department.${userInstance?.department}"/></span>
				...
				<li class="fieldcontain">
					...
					<span class="property-value">${userInstance?.authorities.collect{[ROLE_USER:'用户',ROLE_POST:'发布',ROLE_ADMIN:'管理'][it.authority]}}</span>
				</li>
